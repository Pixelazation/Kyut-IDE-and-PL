...
import splash from '../../../../splash-screen/splash-screen-final.png'

function Landing(): JSX.Element {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-pink-200 via-pink-300 to-pink-500 font-mono p-4">
      <div className="bg-pink-100 shadow-lg rounded-lg p-12 max-w-md text-center space-y-6">
        ...
        <p className="text-2xl space-y-3 text-center font-semibold text-pink-700"> Click on the <VscNewFile className="inline"/> icon to start!</p>
      </div>
    </div>
  );
}
